...
CANONICAL_MAP: Dict[str, Tuple[str, str]] = {
    ...
    "net_margin": ("NET_MARGIN", "FinancialMetric"),
    "cost_of_revenue_ratio": ("COST_OF_REVENUE_RATIO", "FinancialMetric"),
    "operating_expense_ratio": ("OPERATING_EXPENSE_RATIO", "FinancialMetric"),
    "r_and_d_ratio": ("R_AND_D_RATIO", "FinancialMetric"),
    "sg_and_a_ratio": ("SG_AND_A_RATIO", "FinancialMetric"),
    ...
    "sales_general_and_administrative": ("SG_AND_A_EXPENSE", "FinancialMetric"),
    "sales_general_and_administrative_expense": ("SG_AND_A_EXPENSE", "FinancialMetric"),
    "sales_general_and_administrative_expenses": ("SG_AND_A_EXPENSE", "FinancialMetric"),
    ...
    "accounts_receivable": ("ACCOUNTS_RECEIVABLE", "FinancialMetric"),
    "inventories": ("INVENTORIES", "FinancialMetric"),
    "total_current_assets": ("TOTAL_CURRENT_ASSETS", "FinancialMetric"),
    "total_assets": ("TOTAL_ASSETS", "FinancialMetric"),
    "total_current_liabilities": ("TOTAL_CURRENT_LIABILITIES", "FinancialMetric"),
    "total_liabilities": ("TOTAL_LIABILITIES", "FinancialMetric"),
    "total_shareholders_equity": ("TOTAL_SHAREHOLDERS_EQUITY", "FinancialMetric"),
    "gross_profit": ("GROSS_PROFIT", "FinancialMetric"),
    "operating_income": ("OPERATING_INCOME", "FinancialMetric"),
    "pretax_income": ("PRETAX_INCOME", "FinancialMetric"),
    "income_before_income_tax": ("PRETAX_INCOME", "FinancialMetric"),
    "income_before_income_taxes": ("PRETAX_INCOME", "FinancialMetric"),
    "income_tax_expense": ("INCOME_TAX_EXPENSE", "FinancialMetric"),
    "provision_for_income_taxes": ("INCOME_TAX_EXPENSE", "FinancialMetric"),
    ...
    # Generic product mentions must not be promoted to a specific model.
    "graphics_card": ("GPU", "Product"),
    ...
    "a800": ("A800_GPU", "Product"),
    "a800_gpu": ("A800_GPU", "Product"),
    "h800": ("H800_GPU", "Product"),
    "h800_gpu": ("H800_GPU", "Product"),
    "h800_china_export_gpu": ("H800_CHINA_EXPORT_GPU", "Product"),
    "h20": ("H20_GPU", "Product"),
    "h20_gpu": ("H20_GPU", "Product"),
    "h20_china_export_gpu": ("H20_CHINA_EXPORT_GPU", "Product"),
    "geforce": ("GEFORCE_GPU", "Product"),
    "geforce_gpu": ("GEFORCE_GPU", "Product"),
    "geforce_gpus": ("GEFORCE_GPU", "Product"),
    "geforce_rtx_4090": ("GEFORCE_RTX_4090", "Product"),
    "geforce_rtx_4090_gpu": ("GEFORCE_RTX_4090", "Product"),
    "rtx_4090": ("GEFORCE_RTX_4090", "Product"),
    ...
    "nvidia_drive_platform": ("DRIVE_PLATFORM", "Product"),
    "drive": ("DRIVE_PLATFORM", "Product"),
    "drive_agx": ("DRIVE_PLATFORM", "Product"),
    "drive_sim": ("DRIVE_SIM", "Product"),
    "drive_orin": ("DRIVE_ORIN", "Product"),
    "orin": ("DRIVE_ORIN", "Product"),
